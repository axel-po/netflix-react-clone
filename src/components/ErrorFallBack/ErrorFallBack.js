  ...
  return (
    <>
      ...
      <section
        ...
        <Link
          to='/'
          className='px-2 py-4 text-sm rounded-sm inline-flex items-center h-7 bg-gray-50 font-bold sm-2xl:p-5 my-5'
          onClick={resetErrorBoundary}>
          <span className='block'>Accueil Netflix</span>
        </Link>
        <span className='text-red font-bold'>Code d'erreur : {error.message}</span>
      </section>
    </>
  );
}
